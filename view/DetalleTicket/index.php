	...
	<div class="page-content">
		...
		<header class="section-header">
			...
			<div class="box-typical box-typical-padding">
				...
				<div class="col-lg-6">
					...
					<input id="cat_nom" name="cat_nom" class="form-control" readonly>
		...
		<div class="box-typical box-typical-padding" id="pnldetalle">
				...
				<div class="row">
						...
						<div class="col-lg-12">
						<button type="button" id="btnenviar" class="btn btn-rounded btn-primary">Enviar</button>
						<button type="button" id="btncerrarticket" class="btn btn-rounded btn-warning">Cerrar Ticket</button>
